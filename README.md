...
Canonical 계약 `1.3.0`과 Template 좌표 계약 `1.2.0`을 구현한 Windows 10/11 x64용 독립 실행형 Core·CLI·Electron Desktop 앱이다. 기존 plume 코드나 서버, DB, Queue를 사용하지 않으며 실행 중 네트워크 접근을 하지 않는다.
