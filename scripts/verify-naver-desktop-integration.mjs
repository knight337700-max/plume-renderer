...
check("version_alignment", packageJson?.version === "0.9.5" && versions?.desktopAppVersion === "0.9.5" && versions?.canonicalPhaseN7?.desktopCurrent === "0.9.0" && versions?.canonicalPhaseN7_1?.desktopCurrent === "0.9.1" && versions?.canonicalPhaseN7_2?.desktopCurrent === "0.9.2" && versions?.canonicalPhaseN7_3?.desktopCurrent === "0.9.3" && versions?.canonicalPhaseN7_4?.desktopCurrent === "0.9.4" && versions?.canonicalPhaseN7_4Continuation?.desktopCurrent === "0.9.5" && versions?.canonicalPhaseN7_2?.desktopPrevious === "0.9.1" && versions?.canonicalPhaseN7_3?.desktopPrevious === "0.9.2" && versions?.canonicalPhaseN7_4?.desktopPrevious === "0.9.3" && versions?.canonicalPhaseN7_2?.rendererCoreVersion === "0.8.0" && versions?.canonicalPhaseN7_3?.rendererCoreVersion === "0.8.0" && versions?.canonicalPhaseN7_4?.rendererCoreVersion === "0.8.1" && versions?.canonicalPhaseN7_4Continuation?.rendererCoreVersion === "0.8.2" && versions?.documentVersion?.current === "1.21.1", JSON.stringify({ package: packageJson?.version, desktop: versions?.desktopAppVersion, phaseN7: versions?.canonicalPhaseN7, phaseN7_1: versions?.canonicalPhaseN7_1, phaseN7_2: versions?.canonicalPhaseN7_2, phaseN7_3: versions?.canonicalPhaseN7_3, phaseN7_4: versions?.canonicalPhaseN7_4, continuation: versions?.canonicalPhaseN7_4Continuation, document: versions?.documentVersion?.current }));
