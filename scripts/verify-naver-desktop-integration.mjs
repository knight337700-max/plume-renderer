...
check("version_alignment", packageJson?.version === "0.9.2" && versions?.desktopAppVersion === "0.9.2" && versions?.canonicalPhaseN7?.desktopCurrent === "0.9.0" && versions?.canonicalPhaseN7_1?.desktopCurrent === "0.9.1" && versions?.canonicalPhaseN7_2?.desktopCurrent === "0.9.2" && versions?.canonicalPhaseN7_2?.desktopPrevious === "0.9.1" && versions?.canonicalPhaseN7_2?.rendererCoreVersion === "0.8.0" && versions?.documentVersion?.current === "1.21.0", JSON.stringify({ package: packageJson?.version, desktop: versions?.desktopAppVersion, phaseN7: versions?.canonicalPhaseN7, phaseN7_1: versions?.canonicalPhaseN7_1, phaseN7_2: versions?.canonicalPhaseN7_2, document: versions?.documentVersion?.current }));
