...
check("version_alignment", packageJson?.version === "0.9.0" && versions?.desktopAppVersion === "0.9.0" && versions?.canonicalPhaseN7?.desktopCurrent === "0.9.0" && versions?.canonicalPhaseN7?.rendererCoreVersion === "0.8.0" && versions?.documentVersion?.current === "1.21.0", JSON.stringify({ package: packageJson?.version, desktop: versions?.desktopAppVersion, phase: versions?.canonicalPhaseN7, document: versions?.documentVersion?.current }));
