...
check("versions", versions.documentVersion.current === "1.21.4" && versions.canonicalPhaseN7_7_5.rendererCoreVersion === "0.8.6" && versions.canonicalPhaseN8.rendererCoreVersion === "0.8.6" && versions.desktopAppVersion === "0.9.12" && packageJson.version === "0.9.12" && errors.registryVersion === "1.8.1" && typography.registryVersion === "1.6.0", JSON.stringify({ document: versions.documentVersion, historical: versions.canonicalPhaseN7_7_5, current: versions.canonicalPhaseN8, package: packageJson.version }));
