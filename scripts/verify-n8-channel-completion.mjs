...
check("version_policy", ((versions.documentVersion.current === "1.22.0" || versions.documentVersion.current === "1.23.0" || versions.documentVersion.current === "1.23.1" || versions.documentVersion.current === "1.24.0" || versions.documentVersion.current === "1.25.0" || versions.documentVersion.current === "1.26.0" || versions.documentVersion.current === "1.27.0") && versions.canonicalPhaseN8.rendererCoreVersion === "0.8.6" && ["0.10.0", "0.10.1"].includes(versions.desktopAppVersion) && ["0.10.0", "0.10.1"].includes(packageJson.version) && versions.canonicalPhaseN8.platformComposedRuntimeCurrent === "1.1.1" && versions.canonicalPhaseM1?.metaRuntimeImplemented === true) || (versions.documentVersion.current === "1.21.4" && versions.canonicalPhaseN8.rendererCoreVersion === "0.8.6" && versions.desktopAppVersion === "0.9.12" && packageJson.version === "0.9.12" && versions.canonicalPhaseN8.platformComposedRuntimeCurrent === "1.1.1"), JSON.stringify({ document: versions.documentVersion.current, core: versions.canonicalPhaseN8.rendererCoreVersion, desktop: versions.desktopAppVersion, package: packageJson.version, sourceRuntime: versions.canonicalPhaseN8.platformComposedRuntimeCurrent, m1: versions.canonicalPhaseM1 }));
