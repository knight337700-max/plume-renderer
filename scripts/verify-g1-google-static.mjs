...
check("runtime_scope", !(await exists("apps/desktop/renderer-ui/src/google")) && !(await exists("fixtures/golden/google")) && !(await exists("apps/desktop/electron-main/google-upload")) && !(await exists("src/core/google-upload")) && !(await exists("contracts/google/goldens.g1.json")), "no Desktop/upload/Golden runtime scope");
