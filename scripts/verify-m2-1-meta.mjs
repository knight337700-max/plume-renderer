...
check("version_m2_1", versions.canonicalPhaseM2_1?.documentPrevious === "1.22.0" && versions.canonicalPhaseM2_1?.documentCurrent === "1.23.0" && ["1.23.1", "1.24.0", "1.25.0"].includes(versions.documentVersion?.current) && versions.templateContractVersion === "1.9.0" && versions.freeformFormatProfileRegistryVersion === "1.4.0" && versions.canonicalPhaseM2_1?.rendererCoreVersion === "0.9.0" && versions.canonicalPhaseM2_1?.validatorCurrent === "1.9.0" && ["0.10.0", "0.10.1"].includes(packageJson.version), JSON.stringify({ document: versions.documentVersion, template: versions.templateContractVersion, profiles: versions.freeformFormatProfileRegistryVersion, package: packageJson.version }));
