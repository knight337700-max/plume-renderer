...
check("version_m2_1", versions.documentVersion?.previous === "1.22.0" && versions.documentVersion?.current === "1.23.0" && versions.canonicalPhaseM2_1?.documentCurrent === "1.23.0" && versions.templateContractVersion === "1.9.0" && versions.freeformFormatProfileRegistryVersion === "1.4.0" && versions.canonicalPhaseM2_1?.rendererCoreVersion === "0.9.0" && versions.canonicalPhaseM2_1?.validatorCurrent === "1.9.0" && packageJson.version === "0.10.0", JSON.stringify({ document: versions.documentVersion, template: versions.templateContractVersion, profiles: versions.freeformFormatProfileRegistryVersion, package: packageJson.version }));
