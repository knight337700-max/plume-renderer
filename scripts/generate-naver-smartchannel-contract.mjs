...
const contract = {
  $schema: "https://json-schema.org/draft/2020-12/schema", $id: "https://kbr.local/contracts/naver-smartchannel-template-contract-v1.0.0.json", registryVersion: "1.0.0", templateContractVersion: "1.7.0", channel: "NAVER_GFA", placement: "SMARTCHANNEL", layoutMode: "TEMPLATE_LOCKED", compositionMode: "RENDERER_COMPOSED", artifactCardinality: "SINGLE",
