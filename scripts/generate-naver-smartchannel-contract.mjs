...
const contract = {
  $schema: "https://json-schema.org/draft/2020-12/schema", $id: "https://kbr.local/contracts/naver-smartchannel-template-contract-v1.3.0.json", registryVersion: "1.3.0", templateContractVersion: "1.9.0", channel: "NAVER_GFA", placement: "SMARTCHANNEL", layoutMode: "TEMPLATE_LOCKED", compositionMode: "RENDERER_COMPOSED", artifactCardinality: "SINGLE", runtimeFontPolicyRef: "contracts/naver-smartchannel-runtime-font-policy.json", fontCompatibilityRef: "contracts/naver-smartchannel-font-compatibility.json", metricFixturesRef: "contracts/naver-smartchannel-font-metric-fixtures.json", fontResolutionPolicy: { fallbackAllowed: false, exactIdentityRequired: false, runtimeIdentityRequired: true, allowedModes: ["BUNDLED_EXACT", "SYSTEM_EXACT", "EXTERNAL_EXACT"], sourceIdentityPolicy: "SOURCE_EXACT_OR_PROJECT_COMPATIBLE_VERIFIED_DIFFERENT_BUILD", runtimeLookupKey: "fontToken", classification: "PROJECT_COMPATIBILITY_VERIFIED" }, n2Readiness: { ready: true, blockers: [], runtimeFontMode: "PROJECT_COMPATIBLE_VERIFIED", exportContributingSfFonts: [] },
...
schema.properties.sourceResolutionStatus = { type: "string", enum: ["SOURCE_RESOLVED_PROJECT_COMPATIBLE"] };
...
writeJson("contracts/naver-smartchannel-n2-candidates.json", { registryVersion: "1.1.0", status: "REGISTRY_ONLY", sourceResolutionStatus: "SOURCE_RESOLVED_PROJECT_COMPATIBLE", sourceBacked: true, readiness: { ready: true, blockers: [], runtimeFontMode: "PROJECT_COMPATIBLE_VERIFIED", exportContributingSfFonts: [] }, candidates: n2Candidates });
