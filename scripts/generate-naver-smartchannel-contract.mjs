...
const contract = {
  $schema: "https://json-schema.org/draft/2020-12/schema", $id: "https://kbr.local/contracts/naver-smartchannel-template-contract-v1.2.0.json", registryVersion: "1.2.0", templateContractVersion: "1.9.0", channel: "NAVER_GFA", placement: "SMARTCHANNEL", layoutMode: "TEMPLATE_LOCKED", compositionMode: "RENDERER_COMPOSED", artifactCardinality: "SINGLE", runtimeFontPolicyRef: "contracts/naver-smartchannel-runtime-font-policy.json", fontResolutionPolicy: { fallbackAllowed: false, exactIdentityRequired: true, allowedModes: ["BUNDLED_EXACT", "SYSTEM_EXACT", "EXTERNAL_EXACT"], classification: "SOURCE_CONFIRMED" },
...
schema.properties.sourceResolutionStatus = { type: "string", enum: ["SOURCE_RESOLVED_WITH_RUNTIME_FONT_BLOCKER"] };
schema.properties.runtimeFontPolicyRef = { type: "string", minLength: 1 };
schema.properties.fontResolutionPolicy = { type: "object", additionalProperties: false, required: ["fallbackAllowed", "exactIdentityRequired", "allowedModes", "classification"], properties: { fallbackAllowed: { const: false }, exactIdentityRequired: { const: true }, allowedModes: { const: ["BUNDLED_EXACT", "SYSTEM_EXACT", "EXTERNAL_EXACT"] }, classification: { const: "SOURCE_CONFIRMED" } } };
...
writeJson("contracts/naver-smartchannel-n2-candidates.json", { registryVersion: "1.0.0", status: "REGISTRY_ONLY", candidates: n2Candidates });
