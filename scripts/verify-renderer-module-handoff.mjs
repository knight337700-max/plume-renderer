...
if (!(await exists(root))) {
  ...
  const required = ["README.md", "MANIFEST.json", "artifacts/n7-7-4", "artifacts/n7-7-5", "artifacts/n7-7-6", "artifacts/n7-8", "artifacts/n8", "artifacts/m0", "artifacts/m1", "artifacts/m2", "artifacts/m2-1", "contracts", "src", "packages", "scripts", "tests", "fixtures", "reference", "docs", "source-guides", "local-runtime-resources", "package.json", "pnpm-lock.yaml"];
