...
if (!(await exists(root))) {
  ...
  if (["G0_GOOGLE_ADS_STATIC_CAPABILITY_DISCOVERY_AND_ARCHITECTURE", "G0_1_GOOGLE_ARCHITECTURE_ACCEPTANCE_AND_FREEZE"].includes(sourceHandoffPhase) && manifest) manifest.handoffPhase = "M2_3_META_USER_VISUAL_ACCEPTANCE_AND_GOLDEN_FREEZE";
  const required = ["README.md", "MANIFEST.json", "artifacts/n7-7-4", "artifacts/n7-7-5", "artifacts/n7-7-6", "artifacts/n7-8", "artifacts/n8", "artifacts/m0", "artifacts/m1", "artifacts/m2", "artifacts/m2-1", "artifacts/m2-2", "artifacts/m2-2a", "artifacts/m2-3", "artifacts/g0", "artifacts/g0-1", "contracts", "contracts/goldens/meta-static-goldens.json", "contracts/google", "contracts/google/architecture.g0.json", "contracts/google/architecture-freeze.g0.1.json", "artifacts/g0-1/google-static-architecture-freeze-verification.json", "src", "packages", "scripts", "tests", "fixtures", "reference", "docs", "source-guides", "local-runtime-resources", "package.json", "pnpm-lock.yaml"];
