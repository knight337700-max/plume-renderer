...
expect(policy.registryVersion === "1.4.0", "runtime font policy must be v1.4.0");
expect(policy.templateContractVersion === "1.10.0", "runtime font policy template version must be 1.10.0");
expect(policy.status === "FROZEN_FAIL_CLOSED_PSD_EXACT", "runtime font policy must be frozen fail-closed PSD exact");
expect(policy.runtimeStatus === "READY_RENDERER_OWNED_PSD_EXACT", "runtime status must expose renderer-owned PSD exact assets");
