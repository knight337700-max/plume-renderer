...
if (versions.documentVersion?.current === "1.21.2" && versions.integrationContract?.current === "1.8.0" && versions.templateContractVersion === "1.9.0" && versions.desktopAppVersion === "0.9.7" && versions.canonicalPhaseN7_4?.desktopCurrent === "0.9.4" && versions.canonicalPhaseN7_4Continuation?.desktopCurrent === "0.9.5" && versions.canonicalPhaseN7_5?.desktopCurrent === "0.9.6" && versions.canonicalPhaseN7_7?.desktopCurrent === "0.9.7" && versions.freeformFormatProfileRegistryVersion === "1.2.0") pass("version_policy", "Canonical 1.21.2 / Integration 1.8.0 / Template 1.9.0 / FREEFORM Profiles 1.2.0 / Desktop 0.9.7");
