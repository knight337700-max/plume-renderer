...
if (versions.documentVersion?.current === "1.17.0" && versions.integrationContract?.current === "1.8.0" && versions.templateContractVersion === "1.9.0" && versions.desktopAppVersion === "0.8.2") pass("version_policy", "Canonical 1.17.0 / Integration 1.8.0 / Template 1.9.0 / Desktop 0.8.2");
...
if (formatProfiles.registryVersion === "1.1.0" && formatProfiles.catalogStatus === "READY") pass("format_profile_registry_version", "FREEFORM FormatProfile registry is v1.1.0 and catalog READY");
