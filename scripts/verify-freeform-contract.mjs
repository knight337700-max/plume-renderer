...
if (versions.documentVersion?.current === "1.11.0" && versions.integrationContract?.current === "1.6.0" && versions.templateContractVersion === "1.6.0" && versions.desktopAppVersion === "0.8.1") pass("version_policy", "Canonical 1.11.0 / Integration 1.6.0 / Template 1.6.0 / Desktop 0.8.1");
