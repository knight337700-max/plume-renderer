...
check("versions", versions.documentVersion.current === "1.21.4" && versions.desktopAppVersion === "0.9.9" && versions.canonicalPhaseN7_7_4.rendererCoreVersion === "0.8.5" && versions.canonicalPhaseN7_7_5.rendererCoreVersion === "0.8.6" && contract.registryVersion === "1.2.0" && policy.registryVersion === "1.5.0" && manifest.manifestVersion === "1.2.0", JSON.stringify({ historical: versions.canonicalPhaseN7_7_4, current: versions.canonicalPhaseN7_7_5 }));
