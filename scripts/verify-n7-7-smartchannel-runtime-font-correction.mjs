...
check("version_policy", versions?.documentVersion?.current === "1.21.4" && versions?.canonicalPhaseN7_7?.rendererCoreVersion === "0.8.4" && versions?.canonicalPhaseN7_7?.desktopCurrent === "0.9.7" && versions?.canonicalPhaseN7_7_5?.rendererCoreVersion === "0.8.6" && versions?.templateContractVersion === "1.9.0", JSON.stringify({ historical: versions?.canonicalPhaseN7_7, current: versions?.canonicalPhaseN7_7_5 }));
