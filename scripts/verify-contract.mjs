...
check(
  "canonical_document_version",
    versions?.documentVersion?.previous === "1.21.3" && versions?.documentVersion?.current === "1.21.4" && versions?.canonicalPhaseN7_7_5?.documentCurrent === "1.21.4" && versions?.canonicalPhaseN7_7_6?.documentCurrent === "1.21.4" && versions?.canonicalPhaseN7_7_6?.rendererCoreVersion === "0.8.6" && versions?.canonicalPhaseN7_7_6?.desktopCurrent === "0.9.10" && versions?.templateContractVersion === "1.9.0" && versions?.smartChannelTemplateContractVersion === "1.10.0",
