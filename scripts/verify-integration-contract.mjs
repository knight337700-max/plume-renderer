...
if (contract.templateContractVersion === "1.9.0") pass("template_contract", "templateContractVersion is 1.9.0");
else fail("template_contract", `expected 1.9.0, got ${contract.templateContractVersion}`);
