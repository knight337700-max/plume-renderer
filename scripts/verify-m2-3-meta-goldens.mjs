...
check("m2_3_canonical_document", canonicalDocument.includes("Phase M2.3") && canonicalDocument.includes("META user visual acceptance and Golden freeze") && canonicalDocument.includes("**Document version:** 1.23.1"), "canonical document records the M2.3 freeze without changing template coordinates");
