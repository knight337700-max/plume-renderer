...
check("version_m1", versions.documentVersion?.current === "1.22.0" && versions.canonicalPhaseM1?.metaRuntimeImplemented === true && versions.desktopAppVersion === "0.10.0" && packageJson.version === "0.10.0", JSON.stringify({ document: versions.documentVersion?.current, desktop: versions.desktopAppVersion, package: packageJson.version }));
