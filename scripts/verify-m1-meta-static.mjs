...
check("version_m1", ["1.22.0", "1.23.0"].includes(versions.documentVersion?.current) && versions.canonicalPhaseM1?.metaRuntimeImplemented === true && versions.desktopAppVersion === "0.10.0" && packageJson.version === "0.10.0", JSON.stringify({ document: versions.documentVersion?.current, desktop: versions.desktopAppVersion, package: packageJson.version }));
