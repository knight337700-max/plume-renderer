...
expect(compatibility.registryVersion === "1.2.0", "compatibility registry must be v1.2.0");
expect(compatibility.status === "PSD_EXACT_RENDERER_OWNED_PINNED", "compatibility status must record PSD-exact renderer-owned assets");
expect(compatibility.runtimeFontMode === "PSD_EXACT_RENDERER_OWNED", "runtime mode must require renderer-owned exact assets");
...
expect(metrics.status === "RESOLVED_PSD_EXACT_ASSET" && metrics.summary.overflow === 0, "metric fixture status mismatch");
