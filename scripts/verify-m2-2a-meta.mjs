...
check("version_alignment", ["1.23.1", "1.24.0", "1.25.0", "1.28.0"].includes(versions.documentVersion?.current) && versions.templateContractVersion === "1.9.0" && versions.canonicalPhaseM2_2?.rendererCoreVersion === "0.9.0" && versions.canonicalPhaseM2_2a?.desktopCurrent === "0.10.1" && versions.canonicalPhaseM2_2a?.packageCurrent === "0.10.1" && ["0.10.1", "0.11.0"].includes(versions.desktopAppVersion) && ["0.10.1", "0.11.0"].includes(packageJson.version), JSON.stringify({ document: versions.documentVersion, template: versions.templateContractVersion, m2_2a: versions.canonicalPhaseM2_2a, package: packageJson.version }));
