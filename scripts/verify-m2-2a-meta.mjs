...
check("version_alignment", ["1.23.1", "1.24.0", "1.25.0"].includes(versions.documentVersion?.current) && versions.templateContractVersion === "1.9.0" && versions.canonicalPhaseM2_2?.rendererCoreVersion === "0.9.0" && versions.canonicalPhaseM2_2a?.desktopCurrent === "0.10.1" && versions.canonicalPhaseM2_2a?.packageCurrent === "0.10.1" && versions.desktopAppVersion === "0.10.1" && packageJson.version === "0.10.1", JSON.stringify({ document: versions.documentVersion, template: versions.templateContractVersion, m2_2a: versions.canonicalPhaseM2_2a, package: packageJson.version }));
