...
check("versions", versions.documentVersion.current === "1.21.4" && versions.canonicalPhaseN7_7_6.rendererCoreVersion === "0.8.6" && versions.canonicalPhaseN7_7_6.smartChannelTemplateContractVersion === "1.10.0" && versions.desktopAppVersion === "0.9.10" && packageJson.version === "0.9.10", JSON.stringify({ document: versions.documentVersion.current, phase: versions.canonicalPhaseN7_7_6, package: packageJson.version }));
