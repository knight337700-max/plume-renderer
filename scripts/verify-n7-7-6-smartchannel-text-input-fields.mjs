...
check("versions", versions.documentVersion.current === "1.21.4" && versions.canonicalPhaseN7_7_6.rendererCoreVersion === "0.8.6" && versions.canonicalPhaseN7_7_6.smartChannelTemplateContractVersion === "1.10.0" && versions.canonicalPhaseN7_8.rendererCoreVersion === "0.8.6" && versions.desktopAppVersion === "0.9.11" && packageJson.version === "0.9.11", JSON.stringify({ document: versions.documentVersion.current, historical: versions.canonicalPhaseN7_7_6, current: versions.canonicalPhaseN7_8, package: packageJson.version }));
