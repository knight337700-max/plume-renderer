...
expect(contract.registryVersion === "1.1.0", "template registryVersion must be 1.1.0");
expect(contract.templateContractVersion === "1.8.0", "templateContractVersion must be 1.8.0");
...
expect(schema.$id.endsWith("naver-smartchannel-template-v1.1.0.schema.json"), "template schema id must be v1.1.0");
expect(schema.properties.registryVersion.const === "1.1.0", "template schema registry version mismatch");
expect(schema.properties.templateContractVersion.const === "1.8.0", "template schema contract version mismatch");
try {
...
expect(typography.registryVersion === "1.1.0", "typography registry version mismatch");
